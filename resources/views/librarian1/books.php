						...
						<h1>Books List</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
								  ...
								  $user_query="select * from book where status != 'Archive'";
								  ...
								  $user_stmt -> execute();
									...
									$borrow_details = "select * from borrowdetails where book_id = '$id' and borrow_status = 'pending'";
									$borrow_stmt = $pdo -> prepare($borrow_details);
									$borrow_stmt -> execute();
									$row11 = $borrow_stmt->fetch(PDO::FETCH_ASSOC);
									$count = $borrow_stmt->rowCount();
