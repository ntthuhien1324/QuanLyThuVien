						...
						<div class="alert alert-success"><strong>Select Book</strong></div>
                            <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_sql="select * from book where status != 'Archive' ";
								  	$user_stmt = $pdo->prepare($user_sql);
									$user_stmt-> execute(); 
									while($user_row=$user_stmt->fetch(PDO::FETCH_ASSOC)){
									$id=$user_row['book_id'];  
									$cat_id=$user_row['category_id'];
                                    ...
                                    <td><?php echo $user_row['book_id']; ?></td>
                                    <td><?php echo $user_row['book_title']; ?></td>
									<td><?php echo $cat_row ['classname']; ?> </td> 
                                    <td><?php echo $user_row['author']; ?> </td> 
									 <td><?php echo $user_row['publisher_name']; ?></td>
									  <td width=""><?php echo $user_row['status']; ?></td> 
